        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active"id="nuevos">
             <form method="POST" action="<?php echo base_url('insertar_m') ?>">
              <label>INGRESE MARCA</label>
              <input type="text" name="txt_marca" class="form-control mb-3" placeholder="ingrese marca">
                 ...
                 <tr>
                   ...
                   <td>
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="<?php echo base_url().'modificar_m/'.$imp->id_marcas; ?>" class="btn btn-info mb-2">Modificar</a></li>
                        <li><a href="<?php echo base_url().'eliminar_m/'.$imp->id_marcas; ?>" class="btn btn-danger">Eliminar</a></li>
                      </ul>
                    </div>
                   </td>
                 </tr>
